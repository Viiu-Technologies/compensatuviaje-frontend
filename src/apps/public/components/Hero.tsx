...
const Hero = () => {
  // Evita parpadeos o errores de hidratación en SSR para los números formateados
  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden" id="inicio">
      ...
      {/* 1. RESTAURADO: Fondo original con los gradientes exactos que daban el look premium */}
      <div 
      ...
      {/* Contenido Principal con Grid original para no romper anchos */}
      <div
      ...
      >
        <div className="grid lg:grid-cols-2 xl:grid-cols-[1fr_460px] gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          {/* Columna Izquierda: Restaurada idéntica a tu diseño inicial */}
          ...
          {/* Columna Derecha: Tarjetas con dimensiones originales pero ALINEACIÓN INTERNA CORREGIDA */}
          <div className="hidden lg:flex flex-col gap-3 xl:gap-4 w-full">
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    py-5 xl:py-6 px-6
                    flex items-center gap-5 xl:gap-6
                ...
                >
                  ...
                  {/* Contenedor del icono con ancho fijo para perfecta alineación */}
                  <div className={`
                    relative flex-shrink-0 w-14 h-14 flex items-center justify-center rounded-2xl 
                    ${stat.iconBg} shadow-lg ${stat.glow}
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="font-bold text-white/80" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)' }}>
                        {stat.suffix}
                      </span>
                    </div>
                    <p className="text-white/60 font-medium text-sm xl:text-base mt-0.5 truncate">
                      {stat.label}
                    </p>
                  </div>
                </div>
            ...
            {/* CARD EMPRESA: Mismo tamaño, paddings y estructura exacta de filas que los stats de arriba */}
            <div className="group relative overflow-hidden rounded-2xl xl:rounded-3xl hover:!-translate-y-1 hover:!scale-[1.02] !transition-all !duration-300 !ease-out">
              ...
              <div className="relative py-5 xl:py-6 px-6 flex items-center gap-5 xl:gap-6">
                {/* Icono perfectamente alineado con la misma caja (w-14 h-14) */}
                <div className="flex-shrink-0 w-14 h-14 flex items-center justify-center rounded-2xl bg-white/20 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <FaBuilding className="text-2xl text-white" />
                </div>
                
                {/* Textos alineados milimétricamente con los de arriba */}
                <div className="min-w-0 flex-1">
                  <h3 className="text-lg xl:text-xl font-bold text-white mb-0.5">
                    ¿Eres Empresa?
                  </h3>
                  <p className="text-white/85 text-xs xl:text-sm mb-1.5 leading-snug">
                    Certifica tus operaciones y lidera el cambio sostenible.
                  </p>
                  <button className="group/btn inline-flex items-center gap-1 text-emerald-300 hover:text-white font-bold text-xs xl:text-sm transition-colors duration-200">
