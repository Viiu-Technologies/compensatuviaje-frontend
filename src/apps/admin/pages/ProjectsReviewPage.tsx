              ...
              <div className="!p-5 !flex-1 !overflow-y-auto !space-y-6">
                ...
                <div>
                  ...
                  {projectPhotos.length > 0 ? (
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800/50 !p-4 !rounded-xl text-center text-slate-500 dark:text-slate-400 text-sm">
            ...
            <div className="bg-white dark:bg-slate-800 !rounded-2xl !shadow-sm !border border-indigo-200 dark:border-indigo-800 !overflow-hidden">
              ...
              <div className="!p-5 !space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 !mb-2">¿Negociaste un precio distinto? Cámbialo aquí.</p>
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 !mb-2">Limita las ventas de este mes si es necesario.</p>
                  <div className="!relative">
