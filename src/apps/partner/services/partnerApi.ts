...
const normalizeProject = (raw: any): EsgProject => {
  return {
    ...
    base_price_clp_per_ton: parseNumber(
      raw.base_price_clp_per_ton ?? raw.currentBasePriceClpPerTon ?? raw.current_base_price_clp_per_ton
    ),
    currentBasePriceClpPerTon: parseNumber(
      raw.currentBasePriceClpPerTon ?? raw.current_base_price_clp_per_ton ?? raw.base_price_clp_per_ton
    ),
    ...
    impact_unit_type: raw.impact_unit_type,
    impact_unit_spec: raw.impact_unit_spec,
    monthly_stock_approved: parseNumber(raw.monthly_stock_approved),
    monthly_stock_remaining: parseNumber(raw.monthly_stock_remaining),
    stock_period_start: raw.stock_period_start,
    stock_period_end: raw.stock_period_end,
 ...
 * por lo que no se requiere currentBasePriceClpPerTon aquí.
 */
